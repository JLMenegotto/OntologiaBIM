...
### Nota:
          Como se trata de uma pesquisa acadêmica, o servidor configurado utiliza uma licença gratuita do AllegroGraph.  Ele é pausado após um período de 12 hs de inatividade.  
