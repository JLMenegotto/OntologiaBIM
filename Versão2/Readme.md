...
### Nota:
          <p align="justify"> Como se trata de uma pesquisa acadêmica, o servidor configurado utiliza uma licença gratuita do AllegroGraph.
          Ele é pausado após um período de 12 hs de inatividade. Caso a plataforma esteja fora do ar, retorne mais tarde para fazer a consulta.</p> 
